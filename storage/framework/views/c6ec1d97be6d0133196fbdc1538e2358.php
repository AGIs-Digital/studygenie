...
<?php $__env->startSection('title', 'KarriereGenie'); ?>
...
<body class="MainContainer">
	...
	<main class="mainContainer">
		...
		<div class="categoryClouds">
            ...
            <a href="/JobInsider" class="Cloud_Karriere"
				id="textInspirationCloud2">
                <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Erfahre alles Wichtige über alle Berufe!">
                    <img src="<?php echo e(asset('asset/images/info.svg')); ?>" width="20" alt="Info">
                </button>
...
</html><?php /**PATH D:\xampp\htdocs\resources\views/Karriere/KarriereGenie.blade.php ENDPATH**/ ?>