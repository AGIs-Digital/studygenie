...
<link rel="stylesheet" href="<?php echo e(asset('asset/css/ToolsStyle.css')); ?>">
<style>
    .highlight {
...
<body class="MainContainer">
    ...
    <main class="mainContainer">
        <img src="<?php echo e(asset('asset/images/ab1.svg')); ?>" class="ab1" alt=""> <img
            src="<?php echo e(asset('asset/images/ab2.svg')); ?>" class="ab2" alt=""> <img
            src="<?php echo e(asset('asset/images/ab3.svg')); ?>" class="ab3" alt=""> <img
            src="<?php echo e(asset('asset/images/ab4.svg')); ?>" class="ab4" alt="">
        <div class="container">
            <div class="content text-center">
                <h1 class="primary-Heading">Wobei kann ich dir helfen?</h1><br />

                <img id="StudyGenieImage"
                    src="<?php echo e(asset('asset/images/ToolsImage.png')); ?>"
                    alt="StudyGenieImage">
                ...
                <div class="categoryClouds">
                    ...
                    </a> <a href="/Karriere" class="Cloud_Karriere"> <svg
                            xmlns="http://www.w3.org/2000/svg" width="245" height="167"
                            viewBox="0 0 245 167" fill="none">
                    <g filter="url(#filter0_d_168_754)">
                        <path
...
</html><?php /**PATH D:\xampp\htdocs\resources\views/Tools.blade.php ENDPATH**/ ?>