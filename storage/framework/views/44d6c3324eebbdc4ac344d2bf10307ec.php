...
<html lang="de">
<head>
<?php $__env->startSection('title', 'TextAnalyse'); ?>
                                    ...
                                    <div class="group-box">
                                        <span>Dein Text: <strong type="button" class=""
                                            ...
                                            title="Gib hier deinen gesamten Text ein."> <img
                                                src="<?php echo e(asset('asset/images/info-tools.svg')); ?>" width="16" alt="">
                                        </strong>
                                        </span>
				...
				<form id="save_data">
					...
					<div class="modal-body">
						...
						<input type="hidden" name="save_val" id="save_val"> <input
							type="hidden" name="tooltype" value="text_analysis"> <input
...
<?php /**PATH D:\xampp\htdocs\resources\views/Bildung/TextAnalyse.blade.php ENDPATH**/ ?>