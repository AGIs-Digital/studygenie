				...
				<div class="col-md-2">
					<div class="leftCon" style="cursor: pointer">
						<img id="closeIcon" onclick="window.history.back()"
							src="<?php echo e(asset('asset/images/ic_close.png')); ?>" alt="closeIcon">
					...
					<img src="<?php echo e(asset('asset/images/info-tools.svg')); ?>" width="25" alt="">
				</button></h3>
                    <br />
    ...
    <div class="steuerungcontainer">
        ...
        <div class="shop-now">Tutor</div>
            <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Lerne einfach und effektiv">
				<img src="<?php echo e(asset('asset/images/info-tools.svg')); ?>" width="16" alt="">
			</button>
        </div>
    </div>
    <div class="steuerungcontainer">
				...
				<div class="col-md-9">
					<div class="written-green-board">
						...
						<div class="content-written message">
                            <img src="<?php echo e(asset('asset/images/ab3.svg')); ?>" class="ab1" alt=""> <img
			src="<?php echo e(asset('asset/images/ab2.svg')); ?>" class="ab2" alt=""> <img
			src="<?php echo e(asset('asset/images/ab3.svg')); ?>" class="ab1" alt=""> <img
			src="<?php echo e(asset('asset/images/ab4.svg')); ?>" class="ab4" alt="">
            <img
			src="<?php echo e(asset('asset/images/ToolsImage.png')); ?>" class="ab5" alt="">
							...
							<div class="user_input_form">
								<form id="form_user_input">
                                    ...
                                    <div class="save_folder left" id="save_folder" style="display: block"
                                        ...
                                        <img src="<?php echo e(asset('asset/images/savefolder.svg')); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Speichern" width="40"
                                        height="40" alt="">
                                    </div>
...
<?php /**PATH D:\xampp\htdocs\resources\views/Bildung/genieTutor.blade.php ENDPATH**/ ?>