			...
			<div class="row">
                                    ...
                                    <div class="group-box">
                                        <span class="small_text_font">Welcher Beruf interessiert dich?
                                            ...
                                            title="Gib hier den Beruf ein zu dem du eine Übersicht möchtest">
                                                <img src="<?php echo e(asset('asset/images/info-tools.svg')); ?>" width="16"
                                                alt="">
                                        </strong>
                                        </span>
				...
				<div class="col-md-6">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="written-green-board" style="display: flex"
								id="second_box">
...
<?php /**PATH D:\xampp\htdocs\resources\views/Karriere/JobInsider.blade.php ENDPATH**/ ?>