...
<html lang="de">
<head>
<?php $__env->startSection('title', 'Bildung'); ?>
...
<body class="MainContainer">
    ...
    <main class="mainContainer">
        <img src="<?php echo e(asset('asset/images/ab1.svg')); ?>" class="ab1" alt="">
        <img src="<?php echo e(asset('asset/images/ab2.svg')); ?>" class="ab2" alt="">
        <img src="<?php echo e(asset('asset/images/ab3.svg')); ?>" class="ab3" alt="">
        <img src="<?php echo e(asset('asset/images/ab4.svg')); ?>" class="ab4" alt="">
        ...
        <div class="categoryClouds">
            <a href="/GenieCheck" class="Cloud">
                <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Soforthilfe für alle deine Fragen">
                    <img src="<?php echo e(asset('asset/images/info.svg')); ?>" width="20" alt="">
                </button>
            ...
            <?php if((auth()->user()->subscription_name == 'gold' || auth()->user()->subscription_name == 'diamant') && $check): ?>
            <a href="/GenieAutor" class="Cloud">
				...
				<svg xmlns="http://www.w3.org/2000/svg" width="245"
			...
			<?php if((auth()->user()->subscription_name == 'diamant') && $check): ?>
...
<?php /**PATH D:\xampp\htdocs\resources\views/Bildung.blade.php ENDPATH**/ ?>