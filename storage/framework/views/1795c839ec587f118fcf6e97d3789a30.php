...
<html lang="de">
<head>
<?php $__env->startSection('title', 'GenieAutor'); ?>
...
<body class="MainContainer">
	...
	<main class="mainContainer">
		...
		<div class="headerMainContainer">
			<div class="leftCon" onclick="window.history.back()"
				style="cursor: pointer">
				<img id="closeIcon" src="<?php echo e(asset('asset/images/ic_close.png')); ?>"
					alt="closeIcon">
			</div>
			<div class="centerCon">
		...
		<div class="categoryClouds">
			...
			<button type="button" class="btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Knüpfe an deinen Text an und lass dich inspirieren.">
       <img src="<?php echo e(asset('asset/images/info.svg')); ?>" width="20" alt="Info">
   </button> <svg
            ...
            <g filter="url(#filter0_d_168_754)">
                <path
						...
						fill="#F8F8F8" />
                <svg xmlns="http://www.w3.org/2000/svg" width="184"
						height="109" viewBox="0 0 184 109" x="30" y="30">
			...
			</a> <a href="/TextAnalyse" class="Cloud"
				id="textInspirationCloud2"><button type="button" class="btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Schnelle Textkorrektur für Grammatik, Stil und mehr.">
       <img src="<?php echo e(asset('asset/images/info.svg')); ?>" width="20" alt="Info">
...
</html><?php /**PATH D:\xampp\htdocs\resources\views/Bildung/GenieAutor.blade.php ENDPATH**/ ?>