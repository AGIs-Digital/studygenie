            ...
            <div class="CardDiv">
                ...
                <div class="card">
                    ...
                    <div class="thumbnail-Content-Container">
                        <img src="{{ asset('asset/images/landingpage/testimonial3.png') }}" alt="Thumbnail Luke G."
                            loading="lazy">
            ...
            <div class="CardDiv">
                ...
                <div class="card card2">
                    <div class="thumbnail-Content-Container">
                        <img class="quoteMarks" src="{{ asset('asset/images/ic.png') }}" alt="Zitatzeichen"
                            loading="lazy">
                        <img src="{{ asset('asset/images/landingpage/testimonial2.png') }}" alt="Thumbnail Julia S."
                            loading="lazy">
            ...
            <div class="CardDiv">
                ...
                <div class="card">
                    <div class="thumbnail-Content-Container">
                        <img class="quoteMarks" src="{{ asset('asset/images/ic.png') }}" alt="Zitatzeichen"
                            loading="lazy">
                        <img src="{{ asset('asset/images/landingpage/testimonial1.png') }}" alt="Thumbnail Alex M."
                            loading="lazy">
