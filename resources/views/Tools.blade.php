...
<body class="MainContainer">
        ...
        <div class="container">
            <div class="content text-center">
                ...
                <div class="categoryClouds">
                    <a href="/bildung" class="Cloud"> <svg xmlns="http://www.w3.org/2000/svg" width="245"
                            ...
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109"
                                    ...
                                    <text class="textStyle" x="50%" y="65" text-anchor="middle" font-family: 'Milonga' ,
                                        cursive; font-size="24" fill="black" font-weight="400">Bildung</text>
                                </svg>
                            </g>
                            <defs>
                    ...
                    </a> <a href="/Karriere" class="Cloud_Karriere"> <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109"
                                    ...
                                    <path
                                        ...
                                        fill="#2D3E4E" />
                                    <text class="textStyle" x="50%" y="65" text-anchor="middle" font-family: 'Milonga' ,
                                        cursive; font-size="23" fill="#FFFFFF" font-weight="400">Karriere</text>
                                </svg>
                            </g>
                            <defs>
                                <filter id="filter0_d_168_754" x="0" y="0" width="244.92" height="166.98"
    ...
    <script>
        ...
        function startTour() {
            const steps = [{
                    element: document.querySelector('.Cloud svg'),
                    message: 'Hier gib es alles was du für deinen Erfolg in Schule oder Uni brauchst'
                },
                {
                    element: document.querySelector('.Cloud_Karriere svg'),
                    message: 'Alles zu Berufen die zu dir passen, Bewerbungsunterlagen und Tipps für Vorstellungsgespräche für den Start in die Arbeitswelt.'
                },
                {
                    element: document.querySelector('.profile_u'),
                    message: 'Hier kannst du dein Profil verwalten.'
                },
                {
                    element: document.querySelector('.archive'),
                    message: 'Speichere wertvolle Antworten und Tipps aus unseren Chats hier.'
                }
            ];
