            ...
            <div class="row">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="147" height="113" viewBox="0 0 245 167" fill="none">
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109" viewBox="0 0 184 109" x="30" y="30">
                                    ...
                                    <text class="textStyle" x="50%" y="65" text-anchor="middle" font-size="24" fill="#FFFFFF" font-weight="400">Lebenslauf</text>
                                </svg>
                            </g>
                            <defs>
                ...
                <div class="col-md-3" id="cv-form-container">
                    <form id="cv-form">
                        ...
                        <div id="cv-form-buttons" class="send_button_box">
