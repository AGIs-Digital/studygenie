            ...
            <div class="row justify-content-center">
                <div class="col-md-2">
                    <div class="leftCon" style="cursor: pointer">
                        <img id="closeIcon" onclick="window.location.href='/karriere'" src="{{ asset('asset/images/ic_close.png')}}" alt="closeIcon">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="134" height="113" viewBox="0 0 245 167" fill="none">
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109" viewBox="0 0 184 109" x="30" y="30">
                                    ...
                                    <text class="textStyle" x="50%" y="65" text-anchor="middle" font-family="'Milonga', cursive" font-size="24" fill="#FFFFFF" font-weight="400">Mentor</text>
                                </svg>
                            </g>
                            <defs>
                    ...
                    <div class="legende">
                        <h3>Steuerung
                            <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Gib zuerst einen Beruf und wahlweise ein Unternehmen ein, wähle anschließend einen Modus">
