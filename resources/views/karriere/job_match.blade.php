                            ...
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109"
                                    ...
                                    <text class="textStyle" x="50%" y="65" text-anchor="middle" font-family: 'Milonga' ,
                                        cursive; font-size="24" fill="#FFFFFF" font-weight="400">JobMatch</text>
                                </svg>
                        ...
                        <div class="written-green-board">
                            ...
                            <div class="content-written left brain">
                                <div class="left_scroll">
                                    ...
                                    <div class="group-box">
                                        <span class="small_text_font">Fähigkeiten & Stärken: <strong type="button"
                                        ...
                                        </span> <input type="text" placeholder="Analytisches Denken, Kommunikationsfähigkeit, etc." id="field_1" name="field1">
                                    </div>
                                    ...
                                    <div class="group-box">
                                        ...
                                        </span> <input type="text" placeholder="Technologie, Wissensvermittlung, etc." id="field_2" name="field2">
                                    </div>

                                    <div class="group-box">
                                        <span class="small_text_font">Diese Fähigkeiten möchte ich erlernen: <strong
                                                type="button" class="" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Verhandeln, Kommunikation, etc."> <img
                                                    src="{{ asset('asset/images/info-tools.svg') }}" width="16"
                                                    alt="">
                                            </strong>
                                        </span> <input type="text" id="field_3" name="field3" placeholder="Verhandeln, Kommunikation, etc.">
                                    </div>
                                    <div class="group-box">
                                        ...
                                        </span> <input type="text" id="field_4" name="field4" placeholder="In Teams, Alleine, etc.">
                                    </div>
                                    <div class="row radio_button_box">
                                        <div class="col-md-12">
                                            <br> <label>Entscheidungsfreiheit & Kontrolle: <strong type="button"
                                                    class="" data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <div class="col-md-3">
                                            <label> <input type="radio" name="field5" value="wichtig">
                                                <i>wichtig</i></label>
                                        </div>
                                        <div class="col-md-3">
                                            <label> <input type="radio" name="field5" value="neutral">
                                                <i>neutral</i></label>
                                        </div>
                                        <div class="col-md-4">
                                            <label> <input type="radio" name="field5" value="unwichtig">
                                                <i>unwichtig</i></label>
                                        </div>
                                        <br> <br> <br>
                                        <div class="col-md-12">
                                            <label>Persönlichkeitstyp: <strong type="button" class=""
                                                ...
                                                Extrovertiert: Mag Action, ist gern unter Menschen">
                                                    <img src="{{ asset('asset/images/info-tools.svg') }}"
                                                        width="16" alt="">
                                                </strong>
                                            </label>
                                        ...
                                        <div class="col-md-6">
                                            <label> <input type="radio" name="field6" value="introvertiert">
                                                <i>Introvertiert</i></label>
                                        </div>
                                        <div class="col-md-6">
                                            <label> <input type="radio" name="field6" value="extrovertiert">
                                                <i>Extrovertiert</i></label>
                                        </div>
                                        <br> <br>
                                    </div>
                                </div>
                ...
                <form id="save_data">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="save_val" id="save_val"> <input type="hidden" name="tooltype"
                            value="job_match"> <input type="hidden" name="type" value="Karriere"
                            id="Bildung">
                    </div>
