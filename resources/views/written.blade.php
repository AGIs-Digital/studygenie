...
<body class="MainContainer">
	...
	<div id="main-body">
		...
		<div id="written-green-board">
			<div id="Bildung-heading" class="mt-5">Bildung</div>

			<div class="content-written">
				<div class="group-box">
					<span>Which text can I help you with?</span> <input type="text"
						placeholder="Which text can I help you with?">
				</div>
