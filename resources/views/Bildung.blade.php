...
<body class="MainContainer">
	...
	<main class="mainContainer">
		...
		<div class="categoryClouds">
			@php $check = false; $date = auth()->user()->expire_date; if($date !=
			...
			</a> @if((auth()->user()->subscription_name == 'diamant') && $check)

			<a href="/GenieTutor" class="Cloud" id="GenieTutor">
				<button type="button" class="btn" data-bs-toggle="tooltip"
					data-bs-placement="top"
			...
			</a> @else <a onclick="showDialog();" class="Cloud" id="GenieTutor">
				<button type="button" class="btn" data-bs-toggle="tooltip"
					data-bs-placement="top"
					title="Dein Lerncoach für deine Fragen, Übungen und Lernpläne.">
					<img src="{{ asset('asset/images/info.svg') }}" width="20" alt="">
