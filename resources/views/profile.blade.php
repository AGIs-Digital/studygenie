                    ...
                    <div class="col-md-4 d-flex justify-content-center">
                        <div class="planCard">
                            ...
                            <div class="contentPlanCard contentPlanCard3">
                                ...
                                @guest
                                    <button data-bs-toggle="modal" data-bs-target="#loginModal" class="plancardButton">Kostenlos ausprobieren</button>
                                @else
                                    @if(auth()->user()->subscription_name == 'silber')
                                        <button class="plancardButton" disabled>Aktueller Status</button>
                                    @else
                                        <a href="javascript:void(0)" onclick="confirmSilberStatus('{{ route('paypal.payment', 'silber') }}')" class="plancardButton"> Kostenlos </a>
                                    @endif
                                @endguest
                            </div>
                            <br />
