					...
					<div class="leftCon" style="cursor: pointer">
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="134" height="113"
                            ...
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <text class="textStyle" x="40" y="65"
                            ...
                            <br>
                                <div class="left_scroll">
                                    <div class="group-box">
                                        ...
                                        <input type="text" name="field1" id="field1"></textarea>
                                    </div>
                                </div>

							</div>
							<button type="button" class="send_button" id="submitForm">Beruf analysieren</button>
