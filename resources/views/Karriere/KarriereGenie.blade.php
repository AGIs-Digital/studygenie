...
<body class="MainContainer">
	...
	<main class="mainContainer">
		...
		<div class="categoryClouds">
			...
			<a href="/JobMatch" class="Cloud_Karriere" id="textInspirationCloud">
       ...
       <img src="{{ asset('asset/images/info.svg') }}" width="20" alt="Info">
            ...
            <g filter="url(#filter0_d_168_754)">
                ...
                <path
							...
							fill="#F3922A" />
                <text class="textStyle" x="54" y="65"
			...
			</a> <a href="/JobInsider" class="Cloud_Karriere"
				id="textInspirationCloud2"><button type="button" class="btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Erfahre alles Wichtige über alle Berufe!">
       <img src="{{ asset('asset/images/info.svg') }}" width="20" alt="Info">
            ...
            <g filter="url(#filter0_d_168_754)">
                ...
                <text class="textStyle" x="60" y="65"
							font-family: 'Milonga', cursive; font-size="24" fill="#FFFFFF"
							font-weight="400">JobInsider</text>
                </svg>
