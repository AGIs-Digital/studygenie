...
<body class="MainContainer">
	...
	<section class="geniebrain_sec">
		<div class="container-fluid">
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="134" height="113"
                            ...
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <path
									...
									fill="#F3922A"></path>
                                <text class="textStyle" x="18" y="65"
            ...
            <img
			src="{{ asset('asset/images/todayAboutImage.png') }}" class="ab5" alt="">
				...
				<div class="modal-body">
					<form id="save_data">
						...
						<input type="hidden" name="save_val" id="save_val"> <input
							type="hidden" name="tooltype" value="GeniusInterview"> <input
