            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="leftCon" style="cursor: pointer">
                        <img id="closeIcon" onclick="window.history.back()" src="{{ asset('asset/images/ic_close.png') }}" alt="closeIcon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="147" height="113" viewBox="0 0 245 167" fill="none">
                            ...
                            <defs>
                                <filter id="filter0_d_168_754" x="0" y="0" width="244.92" height="166.98" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                    ...
                                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_168_754"></feBlend>
                                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_168_754" result="shape"></feBlend>
                                </filter>
                            </defs>
                        </svg>
                    </div>
                ...
                <div class="col-md-3">
                    <form id="motivation-form">
                        @csrf
                        <h2 style="color: #2D3E4E; font-family: Milonga; font-size: 32px; font-style: normal; font-weight: 400; line-height: 38px; position: relative; margin-top: 3rem;">Motivationsschreiben</h2>
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        <div class="section" id="qualification">
                                            <div class="entry">
                                                <p>Relevante Abschlüsse: <input type="text" name="qualification_grade"></p>
                                                <p>Berufliche Erfahrungen: <input type="text" name="qualification_jobs"></p>
                                    ...
                                    <div class="accordion-body">
                                        <div class="section" id="motivationen">
                                            <div class="entry">
                                                ...
                                                <p>Persönliche Interessen: <input type="text" name="motivationen_level"></p>
                                ...
                                <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        <div class="section" id="stellenbezeichnung">
                                            <div class="entry">
                                                <p>Job/Studiengang: <input type="text" name="stellenbezeichnung_job"></p>
                                                <p>Stellenbeschreibung: <textarea name="stellenbezeichnung_stellenbeschreibung" rows="10"></textarea></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
