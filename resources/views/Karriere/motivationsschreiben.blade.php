...
<body class="MainContainer">
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-2">
                <div class="leftCon" style="cursor: pointer">
                    <img id="closeIcon" onclick="window.history.back()" src="{{ asset('asset/images/ic_close.png') }}"
                        alt="closeIcon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="147" height="113" viewBox="0 0 245 167"
                        fill="none">
                        <g filter="url(#filter0_d_168_754)">
                            <path
                                ...
                                fill="#F8F8F8"></path>
                            <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109" viewBox="0 0 184 109"
                                x="30" y="30">
                                ...
                                <text class="textStyle" x="50%" y="65" text-anchor="middle" font-family: 'Milonga' ,
                                    cursive; font-size="18" fill="#FFFFFF" font-weight="400">Motivationsschreiben</text>
                            </svg>
                        </g>
                        <defs>
            ...
            <div class="col-md-3">
                <form id="motivation-form">
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="section" id="adressat">
                                        <div class="entry">
                                            <p>Unternehmen/Universität: <input type="text" name="adressat_company">
                                            </p>
                            ...
                            <div id="flush-collapseThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="section" id="qualification">
                                        <div class="entry">
                                            <p>Relevante Abschlüsse: <input type="text" name="qualification_grade">
                                            </p>
                                            <p>Berufliche Erfahrungen: <input type="text"
                                                    name="qualification_jobs"></p>
                                            <p>Skills: <input type="text" name="qualification_skills"></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="flush-collapseFour" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="section" id="motivationen">
                                        <div class="entry">
                                            <p>Karriereziele: <input type="text" name="motivationen_type"></p>
                                            <p>Persönliche Interessen: <input type="text"
                                                    name="motivationen_level"></p>
                                            <p>Freitextfeld: <input type="text" name="motivationen_freitext"></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="flush-collapseFive" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="section" id="stellenbezeichnung">
                                        <div class="entry">
                                            <p>Job/Studiengang: <input type="text" name="stellenbezeichnung_job">
                                            </p>
                                            <p>Stellenbeschreibung:
                                                <textarea name="stellenbezeichnung_stellenbeschreibung" rows="10"></textarea>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="text-center"
                        ...
                        <button type="submit" class="send_button" id="submitForm">Download</button>
                    </div>
        ...
        <div class="save_folder copy_path_box" id="copy_box" style="bottom: 80px" onclick="copyText()">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" viewBox="0 0 36 36">
                ...
                $("#submitForm").click(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            document.getElementById('pdf_style').innerHTML = textToType +
                                " <br> <br> ";
                        ...
                        $(document).ready(function() {
                            $("#preview-button").click(function() {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        // Ladezeichen entfernen
                                        $("#preview-button").removeClass('loading-button').text(
                                            "Vorschau");

                                        if (data.status) {
                                            // Füge die OpenAI-Antwort zu den Formulardaten hinzu
                                            formData.append('openai_response', data.data);
                                            document.getElementById('openai_response').value = data
                                                .data;
                                            ...
                                            fetch(route('karriere.motivation.preview'), {
                                                ...
                                                .then(data => {
                                                    ...
                                                    console.log('Server Response:',
                                                        data); // Debugging-Ausgabe

                                                    // Erstelle ein eingebettetes PDF-Element
                                                    const pdfEmbed = document.createElement(
                                                        'iframe');
                                                    pdfEmbed.src =
