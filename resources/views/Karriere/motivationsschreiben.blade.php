                            ...
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109"
                                    ...
                                    <text class="textStyle" x="50%" y="65" text-anchor="middle" font-family: 'Milonga' ,
                                        cursive; font-size="18" fill="#FFFFFF"
                        ...
                        <div class="written-green-board">
                            ...
                            <div class="content-written left brain">
                                <div class="left_scroll">
                                    <div class="group-box">
                                        <span class="small_text_font">Gewünschte Position/Studiengang <strong
                                                type="button" class="" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Wofür genau bewirbst du dich?"> <img
                                    ...
                                    <div class="group-box">
                                        <span class="small_text_font">Qualifikationen und Fähigkeiten <strong
                                                ...
                                                title="Was sind deine relevanten Stärken für diese Stelle?"> <img
                                                    src="{{ asset('asset/images/info-tools.svg') }}" width="16"
                                                    alt="">
                                            </strong>
                                    ...
                                    <div class="group-box">
                                        <span class="small_text_font">Akademischer Hintergrund <strong type="button"
                                    ...
                                    <div class="group-box">
                                        <span class="small_text_font">Berufliche Erfahrungen <strong type="button"
                                                class="" data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="Beschreibe deine bisherigen Erfahrungen (Praktika, Jobs etc.)">
                                    ...
                                    <div class="group-box">
                                        <span class="small_text_font">Persönliche Motivation <strong type="button"
                                                class="" data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="Wieso bewirbst du dich für genau diese Stelle?"> <img
                                                    src="{{ asset('asset/images/info-tools.svg') }}" width="16"
                                                    alt="">
                                            </strong>
                                        </span> <input type="text" id="field_5" name="field5" placeholder="">
                                    </div>

                                    <div class="group-box">
                                        <span class="small_text_font">Bezug zum Unternehmen/Studiengang <strong
                                                type="button" class="" data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                title="Warum genau dieses Unternehmen/Studiengang? Erkläre deine Gründe">
                                                <img src="{{ asset('asset/images/info-tools.svg') }}" width="16"
                                                    alt="">
                                            </strong>
                                        </span> <input type="text" id="field_6" name="field6" placeholder="">
                                    </div>

                                    <div class="group-box">
                                        <span class="small_text_font">Stellenbeschreibung <strong type="button"
                                                class="" data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="Alle anderen Infos, die in die Bewerbung einfließen sollen">
                                                <img src="{{ asset('asset/images/info-tools.svg') }}" width="16"
                                                    alt="">
                                            </strong>
                                        </span>
                                        <textarea id="field_7" name="field7" rows="20" style="width:100%;"
