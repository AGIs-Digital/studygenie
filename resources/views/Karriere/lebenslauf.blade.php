        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="134" height="113" viewBox="0 0 245 167" fill="none">
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109" viewBox="0 0 184 109" x="30" y="30">
                                    ...
                                    <text class="textStyle" x="50%" y="65" text-anchor="middle" font-family: 'Milonga', cursive; font-size="24" fill="#FFFFFF" font-weight="400">Lebenslauf</text>
                                </svg>
                            </g>
                            <defs>
                ...
                <div class="col-md-3">
                    <form id="cv-form">
                        @csrf
                        <h2 style="color: #2D3E4E; font-family: Milonga; font-size: 32px; font-style: normal; font-weight: 400; line-height: 38px; position: relative; margin-top: 3rem;">Lebenslauf</h2>
