...
<style>
    .remove-entry {
        ...
        background-color: #E74C3C; /* Modernes Rot */
        border-radius: 50%; /* Kreisform */
        cursor: pointer;
        margin-left: 10px;
        padding: 5px 8px; /* Polsterung für bessere Form */
        font-size: 14px; /* Lesbare Schriftgröße */
        font-weight: bold; /* Fettgedruckte Schrift */
        display: inline-block; /* Korrekte Anzeige als Button */
        text-align: center; /* Zentrierter Text */
        line-height: 1; /* Linienhöhe für vertikale Zentrierung */
