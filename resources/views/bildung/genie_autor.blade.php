...
<body class="MainContainer">
    ...
    <main class="mainContainer">
        ...
        <div class="categoryClouds">
            ...
            <a href="{{ route('textinspiration.create') }}" class="Cloud" id="textInspirationCloud">
            ...
            </a> <a href="{{ route('textanalysis.create') }}" class="Cloud" id="textInspirationCloud2"><button
                    ...
                    <g filter="url(#filter0_d_168_754)">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109" viewBox="0 0 184 109"
                            ...
                            <path
                                ...
                                fill="#E09E50" />
                            <text class="textStyle" x="50%" y="65" text-anchor="middle" font-family: 'Milonga' ,
                                cursive; font-size="24" fill="#FFFFFF" font-weight="400">TextAnalyse</text>
                        </svg>
