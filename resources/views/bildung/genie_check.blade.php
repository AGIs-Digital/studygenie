                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="134" height="113" viewBox="0 0 245 167" fill="none">
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109" viewBox="0 0 184 109" x="30" y="30">
                                    ...
                                    <text class="textStyle" x="50%" y="65" text-anchor="middle" font-size="24" fill="#FFFFFF" font-weight="400">Fragen</text>
                                </svg>
                            </g>
                            <defs>
                        ...
                        <div class="content-written left">
                            <div class="left_scroll">
                                <form id="myForm">
                                    ...
                                    <div class="group-box">
                                        <span>Deine Frage: 
                                            <strong type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Worum geht es? Matheaufgaben, Textaufgaben ich kann alles prüfen!">
