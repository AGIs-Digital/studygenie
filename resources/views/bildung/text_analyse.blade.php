            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="leftCon" style="cursor: pointer">
                        <img id="closeIcon" onclick="window.location.href='/bildung/genieautor'" src="{{ asset('asset/images/ic_close.png') }}" alt="closeIcon">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="134" height="113" viewBox="0 0 245 167" fill="none">
                            <g filter="url(#filter0_d_168_754)">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="184" height="109" viewBox="0 0 184 109" x="30" y="30">
                                    ...
                                    <text class="textStyle" x="50%" y="65" text-anchor="middle"  font-size="24" fill="#FFFFFF" font-weight="400">TextAnalyse</text>
                                </svg>
                            </g>
                            <defs>
                        ...
                        <div class="output">
                            <div class="content-written left">
                                <div class="left_scroll">
                                    <div class="group-box">
                                        <span>Dein Text: <strong type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Bei längeren Texten empfehlen wir, jeden Absatz einzeln zu prüfen."> <img src="{{ asset('asset/images/info-tools.svg') }}" width="16" alt=""></strong></span>
                                        <textarea name="text1" id="field1" rows="10" style="width:100%;" oninput="this.style.height = '';this.style.height = this.scrollHeight + 'px'" placeholder="Deinen aktuellen Text hier eingeben"></textarea>
                                    </div>
                                </div>
