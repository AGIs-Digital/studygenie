            ...
            <div class="row justify-content-center">
                <div class="col-md-2">
                    <div class="leftCon" style="cursor: pointer">
                        <img id="closeIcon" onclick="window.location.href='/bildung'" src="{{ asset('asset/images/ic_close.png') }}" alt="closeIcon" loading="lazy">
                    ...
                    <div class="legende">
                        <h3>Steuerung<button type="button" class="btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Gib zuerst dein Bildungslevel und das Thema ein, wähle anschließend einen Modus">
                                <img src="{{ asset('asset/images/info-tools.svg') }}" width="25" alt="" loading="lazy">
                            </button></h3>
                        <br />
                            ...
                            <div class="user_input_form">
                                <form id="form_user_input" style="display: flex; align-items: center; gap: 10px;" method="POST" action="{{ route('bildung.genie_tutor.store') }}">
                                    ...
                                    <div class="save_folder left" id="save_folder" style="display: block" data-bs-toggle="modal" data-bs-target="#saveModal">
                                        <img src="{{ asset('asset/images/savefolder.svg') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Speichern" width="40" height="40" alt="" loading="lazy">
                                    </div>
