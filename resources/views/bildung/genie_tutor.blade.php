            ...
            <div class="row justify-content-center">
                <div class="col-md-2">
                    <div class="leftCon" style="cursor: pointer">
                        <img id="closeIcon" onclick="window.location.href='/bildung'" src="{{ asset('asset/images/ic_close.png') }}" alt="closeIcon">
                ...
                <div class="col-md-9">
                    <div class="output">
                        <div class="content-written message">
                            <img src="{{ asset('asset/images/ab3.svg') }}" class="ab1" alt="">
